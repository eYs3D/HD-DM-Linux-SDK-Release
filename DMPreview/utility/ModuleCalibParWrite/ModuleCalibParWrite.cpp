...
int WriteRectLogData_temp(eSPCtrl_RectLogData &rectifyData, void *pHandleEtronDI, PDEVSELINFO pDevSelInfo)
{
    ...
    qDebug() << "WriteRectLogData_temp fix_ratio1:" << fix_ratio1;
    qDebug() << "WriteRectLogData_temp fix_ratio2:" << fix_ratio2;
    ...
    qDebug() << "WriteRectLogData_temp L_M00 iM1[0]:" << iM1[0];
    qDebug() << "WriteRectLogData_temp L_M00 data:" << data;
    ...
    data = data & (((unsigned int)(-1)) >> ((8 * sizeof(int)) - effective_bits));
    qDebug() << "WriteRectLogData_temp L_M01 iM1[1]:" << iM1[1];
    qDebug() << "WriteRectLogData_temp L_M01 data:" << data;
    ...
    data = data & (((unsigned int)(-1)) >> ((8 * sizeof(int)) - effective_bits));
    qDebug() << "WriteRectLogData_temp L_M02 iM1[2]:" << iM1[2];
    qDebug() << "WriteRectLogData_temp L_M02 data:" << data;
    ...
    data = data & (((unsigned int)(-1)) >> ((8 * sizeof(int)) - effective_bits));
    qDebug() << "WriteRectLogData_temp L_M10 iM1[3]:" << iM1[3];
    qDebug() << "WriteRectLogData_temp L_M10 data:" << data;
    ...
    data = data & (((unsigned int)(-1)) >> ((8 * sizeof(int)) - effective_bits));
    qDebug() << "WriteRectLogData_temp L_M11 iM1[4]:" << iM1[4];
    qDebug() << "WriteRectLogData_temp L_M11 data:" << data;
    ...
    data = data & (((unsigned int)(-1)) >> ((8 * sizeof(int)) - effective_bits));
    qDebug() << "WriteRectLogData_temp L_M12 iM1[5]:" << iM1[5];
    qDebug() << "WriteRectLogData_temp L_M12 data:" << data;
    ...
    data = data & (((unsigned int)(-1)) >> ((8 * sizeof(int)) - effective_bits));
    qDebug() << "WriteRectLogData_temp L_M20 iM1[6]:" << iM1[6];
    qDebug() << "WriteRectLogData_temp L_M20 data:" << data;
    ...
    data = data & (((unsigned int)(-1)) >> ((8 * sizeof(int)) - effective_bits));
    qDebug() << "WriteRectLogData_temp L_M21 iM1[7]:" << iM1[7];
    qDebug() << "WriteRectLogData_temp L_M21 data:" << data;
    ...
    data = data & (((unsigned int)(-1)) >> ((8 * sizeof(int)) - effective_bits));
    qDebug() << "WriteRectLogData_temp L_M22 iM1[8]:" << iM1[8];
    qDebug() << "WriteRectLogData_temp L_M22 data:" << data;
    ...
    data = data & (((unsigned int)(-1)) >> ((8 * sizeof(int)) - effective_bits));
    qDebug() << "WriteRectLogData_temp L_CX rectifyData.CamMat1[2]:" << rectifyData.CamMat1[2];
    qDebug() << "WriteRectLogData_temp L_CX data:" << data;
    ...
    data = data & (((unsigned int)(-1)) >> ((8 * sizeof(int)) - effective_bits));
    qDebug() << "WriteRectLogData_temp L_CY rectifyData.CamMat1[5]:" << rectifyData.CamMat1[5];
    qDebug() << "WriteRectLogData_temp L_CY data:" << data;
    ...
    data = data & (((unsigned int)(-1)) >> ((8 * sizeof(int)) - effective_bits));
    qDebug() << "WriteRectLogData_temp L_FX rectifyData.CamMat1[0]:" << rectifyData.CamMat1[0];
    qDebug() << "WriteRectLogData_temp L_FX data:" << data;
    ...
    data = data & (((unsigned int)(-1)) >> ((8 * sizeof(int)) - effective_bits));
    qDebug() << "WriteRectLogData_temp L_FY rectifyData.CamMat1[4]:" << rectifyData.CamMat1[4];
    qDebug() << "WriteRectLogData_temp L_FY data:" << data;
    ...
    data = data & (((unsigned int)(-1)) >> ((8 * sizeof(int)) - effective_bits));
    qDebug() << "WriteRectLogData_temp R_M00 iM2[0]:" << iM2[0];
    qDebug() << "WriteRectLogData_temp R_M00 data:" << data;
    ...
    data = data & (((unsigned int)(-1)) >> ((8 * sizeof(int)) - effective_bits));
    qDebug() << "WriteRectLogData_temp R_M01 iM2[1] :" << iM2[1];
    qDebug() << "WriteRectLogData_temp R_M01 data:" << data;
    ...
    data = data & (((unsigned int)(-1)) >> ((8 * sizeof(int)) - effective_bits));
    qDebug() << "WriteRectLogData_temp R_M02 iM2[2]:" << iM2[2];
    qDebug() << "WriteRectLogData_temp R_M02 data:" << data;
    ...
    data = data & (((unsigned int)(-1)) >> ((8 * sizeof(int)) - effective_bits));
    qDebug() << "WriteRectLogData_temp R_M10 iM2[3]:" << iM2[3];
    qDebug() << "WriteRectLogData_temp R_M10 data:" << data;
    ...
    data = data & (((unsigned int)(-1)) >> ((8 * sizeof(int)) - effective_bits));
    qDebug() << "WriteRectLogData_temp R_M11 iM2[4]:" << iM2[4];
    qDebug() << "WriteRectLogData_temp R_M11 data:" << data;
    ...
    data = data & (((unsigned int)(-1)) >> ((8 * sizeof(int)) - effective_bits));
    qDebug() << "WriteRectLogData_temp R_M12 iM2[5]:" << iM2[5];
    qDebug() << "WriteRectLogData_temp R_M12 data:" << data;
    ...
    data = data & (((unsigned int)(-1)) >> ((8 * sizeof(int)) - effective_bits));
    qDebug() << "WriteRectLogData_temp R_M20 iM2[6]:" << iM2[6];
    qDebug() << "WriteRectLogData_temp R_M20 data:" << data;
    ...
    data = data & (((unsigned int)(-1)) >> ((8 * sizeof(int)) - effective_bits));
    qDebug() << "WriteRectLogData_temp R_M21 iM2[7]:" << iM2[7];
    qDebug() << "WriteRectLogData_temp R_M21 data:" << data;
    ...
    data = data & (((unsigned int)(-1)) >> ((8 * sizeof(int)) - effective_bits));
    qDebug() << "WriteRectLogData_temp R_M22 M2[8]:" << M2[8];
    qDebug() << "WriteRectLogData_temp R_M22 data:" << data;
    ...
    data = data & (((unsigned int)(-1)) >> ((8 * sizeof(int)) - effective_bits));
    qDebug() << "WriteRectLogData_temp R_CX rectifyData.CamMat2[2]:" << rectifyData.CamMat2[2];
    qDebug() << "WriteRectLogData_temp R_CX data:" << data;
    ...
    data = data & (((unsigned int)(-1)) >> ((8 * sizeof(int)) - effective_bits));
    qDebug() << "WriteRectLogData_temp R_CY rectifyData.CamMat2[5]:" << rectifyData.CamMat2[5];
    qDebug() << "WriteRectLogData_temp R_CY data:" << data;
    ...
    data = data & (((unsigned int)(-1)) >> ((8 * sizeof(int)) - effective_bits));
    qDebug() << "WriteRectLogData_temp R_FX rectifyData.CamMat2[0]:" << rectifyData.CamMat2[0];
    qDebug() << "WriteRectLogData_temp R_FX data:" << data;
    ...
    data = data & (((unsigned int)(-1)) >> ((8 * sizeof(int)) - effective_bits));
    qDebug() << "WriteRectLogData_temp R_FY rectifyData.CamMat2[4]:" << rectifyData.CamMat2[4];
    qDebug() << "WriteRectLogData_temp R_FY data:" << data;
    ...
    qDebug() << "WriteRectLogData_temp finish";
    return 0;
}
...
int WriteRectifyLogData(eSPCtrl_RectLogData &rectifyData, void *pHandleEtronDI, PDEVSELINFO pDevSelInfo, int index)
{
    ...
    int net = APC_GetLogData(pHandleEtronDI, pDevSelInfo, buffer, 4096, &nothin, index,ALL_LOG);
    if (APC_OK == net)
    {
